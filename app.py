...
with tab8:
    ...
    if press_df.empty:
        ...
        press_2['BS Miss %'] = (press_2['BS Miss'] / sum(press_2['BS Miss'], press_2['BS Make'], press_2['ES Miss'], press_2['ES Make'])* 100).fillna(0)
        press_2['BS Make %'] = (press_2['BS Make'] / sum(press_2['BS Miss'], press_2['BS Make'], press_2['ES Miss'], press_2['ES Make'])* 100).fillna(0)
        press_2['ES Make %'] = (press_2['ES Make'] / sum(press_2['BS Miss'], press_2['BS Make'], press_2['ES Miss'], press_2['ES Make'])* 100).fillna(0)
        press_2['ES Miss %'] = (press_2['ES Miss'] / sum(press_2['BS Miss'], press_2['BS Make'], press_2['ES Miss'], press_2['ES Make'])* 100).fillna(0)
