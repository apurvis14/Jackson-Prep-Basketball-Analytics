...
with tab2:
        st.markdown(
        """
        <h2 style='text-align: center; text-decoration:underline; font-weight:bold'>Season Stats</h2>
        """,
        unsafe_allow_html=True
    )
        ...
        with right_col:
            if selected_player == "Team":
                st.markdown(styled_text("Jackson Prep Team", size=36, weight='normal', margin="0px", margin1="8px",underline=False, center=True, vertical=True), unsafe_allow_html=True)
                st.markdown(styled_text("3-4 (0-0)", size=24, weight='normal', margin="0px", margin1="8px", underline=False, center=True, vertical=True), unsafe_allow_html=True)
            else:
                st.markdown(styled_text(f"{selected_player}", size=36, weight='normal', margin="0px", margin1="8px",underline=False, center=True, vertical=True), unsafe_allow_html=True)
                st.markdown(styled_text("#14 Power Forward", size=24, weight='normal', margin="0px", margin1="8px", underline=False, center=True, vertical=True), unsafe_allow_html=True)
