...
with tab2:
        ...
        with right_col:
            if selected_player == "Team":
                st.markdown(styled_text("Jackson Prep Team\n", size=36, weight='normal', margin="0px", margin1="8px",underline=False, center=True, vertical=True), unsafe_allow_html=True)
                ...
                st.markdown(styled_text(f"{selected_player}\n", size=36, weight='normal', margin="0px", margin1="8px",underline=False, center=True, vertical=True), unsafe_allow_html=True)
