...
def get_updated_zones():
    ...
    def threept_sector(start_ang, end_ang, inner_radius=ARC_R, outer_radius=None):
        # Default to a slightly smaller outer radius if none is provided
        if outer_radius is None:
            outer_radius = R_OUT - 15  # Pull arc closer to baseline
...
def plot_zone_chart(df):
    ...
    plt.savefig("high_school_basketball_zone_shot_chart_full.png")
    plt.show()
